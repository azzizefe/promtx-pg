...
export async function handleHealthCheck(req, headers) {
    try {
        // Ping database
...
export async function handleMetrics(req, headers) {
...
export async function handleEventsLog(req, headers) {
    try {
...
export async function handleFeedback(req, headers) {
    try {
        const body = await req.json();
