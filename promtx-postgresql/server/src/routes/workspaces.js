...
export async function handleWorkspaceCreate(req, headers) {
    try {
...
export async function handleWorkspaceList(req, headers) {
    try {
...
export async function handleWorkspaceInvite(req, headers) {
    return new Response(JSON.stringify({ status: 'success', invitationSent: true }), {
        status: 200,
        headers: { 'Content-Type': 'application/json', ...Object.fromEntries(headers) }
    });
}
export async function handleWorkspaceRemoveMember(req, headers) {
